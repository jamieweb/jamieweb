...
<div class="body">
    ...
    <p>Please see the <a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/" target="_blank" rel="noopener">associated GitHub repository</a> for details on the hosts-file-integrity scripts.</p>
...
0.0.0.0 another-blocked-website.tld</pre>
    ...
    <div class="centertext"><p><b><a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/" target="_blank" rel="noopener">https://github.com/JamieOnUbuntu/hosts-file-integrity/</a></b></p></div>
    ...
    <p><b>All usage details for the script are available on the <a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/" target="_blank" rel="noopener">GitHub repository</a>.</b></p>
    ...
    <p>There are two scripts available in the GitHub repository: "<a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/blob/master/update-verify-file.sh" target="_blank" rel="noopener">update-verify-file.sh</a>" and "<a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/blob/master/verify-implement-file.sh" target="_blank" rel="noopener">verify-implement-file.sh</a>".</p>
    ...
    <div class="centertext"><p><b><u><i>Note that the code snippets below only show the logic, not the full code which includes nicely formatted output, etc.<br/>See the <a href="https://github.com/JamieOnUbuntu/hosts-file-integrity/" target="_blank" rel="noopener">GitHub repository</a> for the full code.</i></u></b></p></div>

...
<div class="body">
    ...
    <div class="centertext"><img src="/images/sleeping-shapes.png"></div>
    ...
    <p>In order to implement this on my site without using JavaScript or PHP, I used a nifty CSS trick that I <a href="https://stackoverflow.com/questions/19050488" target="_blank">found on StackExchange</a>. The trick uses a HTML form checkbox. A different background image is set for each state (checked or unchecked) of the checkbox/label combo, causing the image to change when the checkbox is toggled. This is transparent to the user, since all they can see is a normal image. I ended up changing the checkbox to a single radio button in order to prevent the image from changing multiple times.</p>
    <p>I have used a similar animation technique previously in order to create a "Steam for Linux" animation, as seen <a href="https://youtu.be/yByIR8xrYAg" target="_blank">here</a>.</p>
    <p>LevelXML:</p>
    <pre>    &ltlevelXML&gt

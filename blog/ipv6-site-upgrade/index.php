...
89.34.99.41</pre>
    ...
    <p>Reverse DNS is also set up. A reverse lookup of 2a01:4020:1::129 returns jamieweb.net.
    <pre>jamie@box:~$ dig @8.8.8.8 +short -x 2a01:4020:1::129
jamieweb.net.</pre>
...
&lt;/VirtualHost&gt;</pre>
    ...
    <p>You can test these configurations out at <a href="http://89.34.99.41" target="_blank">http://89.34.99.41</a> and <a href="http://[2a01:4020:1::129]" target="_blank">http://[2a01:4020:1::129]</a>.
    ...
    <p><b>Edit 19th Aug 2017 @ 3:31pm:</b> <i>I have configured two new subdomains for IPv4/6 testing: <a href="https://ipv4.jamieweb.net" target="_blank">https://ipv4.jamieweb.net</a> and <a href="https://ipv6.jamieweb.net" target="_blank">https://ipv6.jamieweb.net</a>. These subdomains are only accessible over the protocol version specified, so they are very useful for testing your connection. I submitted these two subdomains to <a href="http://test-ipv6.com" target="_blank">http://test-ipv6.com</a> and my site is now listed on the "Other IPv6 Sites" tab, which is visible if you pass the IPv6 test.</p>
</div>

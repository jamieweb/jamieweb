...
&#x2517&#x2501&#x2501 <a href="#conclusion">Conclusion</a></pre>
    ...
    <p class="two-no-mar centertext"><i>Browsing to jamieweb.bit in Chromium on Xubuntu. Note that TLS does not provide authenticity or identification in Namecoin, as this is provided by the blockchain instead. In this case, the Chromium "Not secure" warning can be safely ignored.</i></p>
...
{"ip":"139.162.222.67", "ip6":"2a01:7e00:e001:c500::1", "map": {"*": {"ip":"139.162.222.67", "ip6":"2a01:7e00:e001:c500::1"}}}</pre>
    ...
    <p>You can also delegate control of your domain to standard nameservers using "ns" records, however this is not recommended as it is a centralized solution - the whole point of Namecoin is decentralization. It is much better to have your entire DNS zone stored in the Namecoin blockchain.</p>
    <p>For full information on the various domain configuration values, there is a very useful reference table on the Namecoin Wiki. Please see: <a href="https://wiki.namecoin.info/?title=Domain_Name_Specification_2.0#Value_field" target="_blank" rel="noopener">"Domain Name Specification 2.0" on the Namecoin Wiki</a></p>

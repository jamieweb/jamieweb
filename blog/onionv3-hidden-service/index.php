...
&#x2517&#x2501&#x2501 <a href="#conclusion">Conclusion</a></pre>
    ...
    <p>Download and verify Tor (standalone) from the <a href="https://www.torproject.org/download/download.html" target="_blank">Tor downloads page</a>. Below are my verifications for Tor 0.3.2.2 Alpha and Tor Browser 7.5a5 for Linux 64 bit, but always make sure to do your own verifications too:</p>
...
&lt;/VirtualHost&gt;</pre>
    ...
    <h2 id="vanitygeneration">Vanity Address Generation</h2>
    <p>As with my <a href="http://jamiewebgbelqfno.onion" target="_blank">Onion v2 hidden service</a>, I am very interested in generating a vanity address to use for my site. As of writing this, there are no tools available for Onion v3 vanity address generation. However, as I did with the Onion v2 addresses, I am looking into writing a basic script to perform the cryptography outside of Tor in order to generate addresses automatically. This isn't designed to be a highly efficient program to generate millions of addresses per second, just a basic script that is able to do it faster than a human. I think that this will be much harder for Onion v3 though, since the cryptography is more complicated and I am less familliar with ECC than I am with RSA.</p>
    ...
    <p>When it comes to a proper program for Onion v3 vanity address generation, I am not sure what vanity address length and timings will be achievable. With Onion v2, an 8 character vanity address is realistically achievable with an average home computer running for around a month. Onion v3 addresses are still Base32, but are 56 characters rather than 16, so the search space is significantly larger. This could result in longer vanity addresses being possible, but we'll have to wait and see. Hopefully this will be something that I'll be able to set going on my <a href="/projects/computing-stats/" target="_blank">Raspberry Pi cluster</a> sometime in the future.</p>
    <p>I am also interested to see what Facebook are going to do with their <a href="http://facebookcorewwwi.onion" target="_blank">Onion v2 hidden service</a>. They are one of the few organisations to have an Extended Validation (EV) SSL certificate for their hidden service, so I wonder if DigiCert will issue a new one to them when/if Facebook upgrades to Onion v3?</p>

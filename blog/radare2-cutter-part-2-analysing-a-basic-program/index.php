...
<div class="body">
    ...
    <h2>Part 2: Analysing a Basic Program</h2>
    <hr>
    <p><b>Date</b></p>
    <div class="display-flex">
        <div>
            ...
            <p>This is part 2 of a 3 part series on reverse engineering with Cutter:</p>
...
int main(){
    ...
    <img class="radius-8" src="odd-even-take-input.png" width="1000px" title="Cutter Showing the Assembly Code Responsible for Prompting for User Input" alt="A screenshot of the Cutter interface with the assembly code for prompting for user input showing.">
    ...
    <img class="radius-8" src="odd-even-catch.png" width="1000px" title="The Cutter Disassembly View Showing the Assembly for a Catch" alt="A screenshot of the Cutter interface with the assembly code for a catch showing.">
    <p>While you wouldn't normally have the knowledge of a try/catch being used in a particular place, it is usually possible to make an educated guess based on the behaviour of the program. I'm going to cover more about this in my walkthrough for <a href="#sams-crackme">Sam's Crackme</a>.</p>
    ...
    <img class="radius-8" src="odd-even-number-check.png" width="1000px" title="Cutter Showing the Assembly Code Responsible for Determining Whether a Number is Odd or Even" alt="A screenshot of the Cutter interface with the assembly code for determining whether the user inputted number is odd or even.">
...
AND    1 (Only Checking LSB)
    ...
    <img class="radius-8" src="odd-even-print-result.png" width="1000px" title="Cutter Showing the Assembly Code Responsible for Determining and Printing the Result" alt="A screenshot of the Cutter interface with the assembly code for determining and printing whether the inputted number was odd or even.">

...
<div class="body">
    ...
    <pre class="contents"><b>Restricting and Locking Down SSH Users</b>
...
$ cp /lib /lib64 .</pre>
  ...
  ChrootDirectory /home/service_pi/sftp/</pre></li>
        ...
        <li>The chroot directory (<code>/home/service_pi/sftp/</code>) is fully owned by root, and only the exact files that <code>service_pi</code> needs to be able to write to have write permissions.</li>

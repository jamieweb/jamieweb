...
Primary key fingerprint: B55E 70A9 5AC7 9474 504C  30D0 DA11 364B 4760 E444
    ...
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-install-01.png"></center>
    <p>Next are the language and keyboard selection screens:</p>
    <center><img class="subgraph-img-1" width="322px" src="/blog/subgraph-os-overview/subgraph-install-02.png"><img width="322px" class="subgraph-img-1" src="/blog/subgraph-os-overview/subgraph-install-03.png"><img width="320px" src="/blog/subgraph-os-overview/subgraph-install-04.png"></center>
    <p>Now you must set up a password for the Subgraph user account. The default user account in Subgraph is "user" (/home/user/).</p>
    <center><img src="/blog/subgraph-os-overview/subgraph-install-05.png"></center>
    ...
    <center><img class="subgraph-img-2" width="491px" src="/blog/subgraph-os-overview/subgraph-install-06.png"><img width="491px" src="/blog/subgraph-os-overview/subgraph-install-07.png"></center>
    <p>Now you have to choose a password for the FDE. You will be prompted for this password whenever booting in Subgraph.</p>
    <center><img src="/blog/subgraph-os-overview/subgraph-install-08.png"></center>
    ...
    <center><img src="/blog/subgraph-os-overview/subgraph-install-09.png"></center>
    <p>Subgraph will now install:</p>
    <center><img class="subgraph-img-2" width="491px" src="/blog/subgraph-os-overview/subgraph-install-10.png"><img width="491px" src="/blog/subgraph-os-overview/subgraph-install-11.png"></center>
    <p>Select a device to install GRUB on. This is where the installer will fail if you are in UEFI mode.</p>
    <center><img class="subgraph-img-2" width="491px" src="/blog/subgraph-os-overview/subgraph-install-12.png"><img width="491px" src="/blog/subgraph-os-overview/subgraph-install-13.png"></center>
    <p>Subgraph is now installed!</p>
    <center><img src="/blog/subgraph-os-overview/subgraph-install-14.png"></center>
    <p>Entering the FDE password:</p>
    <center><img class="subgraph-img-2" width="491px" src="/blog/subgraph-os-overview/subgraph-install-15.png"><img width="491px" src="/blog/subgraph-os-overview/subgraph-install-16.png"></center>

    <h2 id="usage">Usage</h2>
    <p>The classic Gnome 3 launcher is present in Subgraph:</p>
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-launcher.png"></center>
    <p>Nautilus is the default file manager, the same as Ubuntu and many other distributions:</p>
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-nautilus.png"></center>
    ...
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-tor-bootstrap.png"></center>
    ...
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-oz-profiles.png"></center>    
<p>Subgraph also has a very tight firewall. If an application tries to access the internet, the user will be prompted with information on the connection attempt. The purpose of this is to deny network access to applications that don't need it or shouldn't have it. The image viewer application obviously does not need network access, so if it tries to connect then something funny is going on.</p>
    ...
    <center><img class="subgraph-img-2" width="491px" src="/blog/subgraph-os-overview/subgraph-login-prompt.png"><img width="491px" src="/blog/subgraph-os-overview/subgraph-logged-in.png"></center>
    ...
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-vm-desktop.png"></center>
    ...
    <center><img width="1000px" src="/blog/subgraph-os-overview/subgraph-vm-openbox.png"></center>

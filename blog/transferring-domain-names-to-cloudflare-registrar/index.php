...
<div class="body">
    ...
    <p>Unfortunately it required me to log in with my username and password in order to verify the email address. It's poor security practice to provide credentials after clicking a link, especially to Cloudflare which is probably one of the most important accounts people own. Maybe it was a strange ICANN rule requiring the log in?</p>
    ...
    <p>Once the authorization code has been accepted, you can set the domain name contact information that will be used in WHOIS.</p>

...
while true; do
    ...
    <p><a href="https://www.privacy-regulation.eu/en/article-5-principles-relating-to-processing-of-personal-data-GDPR.htm" target="_blank" rel="noopener">Article 5(1)(b)</a> allows personal data to be (trimmed excerpt, see full legal text):</p>
    <blockquote>...collected for specified, explicit and legitimate purposes and not further processed in a manner that is incompatible with those purposes; further processing for (...) statistical purposes shall, in accordance with Article 89(1), not be considered to be incompatible with the initial purposes...</blockquote>
    <p><a href="https://www.privacy-regulation.eu/en/article-5-principles-relating-to-processing-of-personal-data-GDPR.htm" target="_blank" rel="noopener">Article 5(1)(e)</a> states that personal data must be (trimmed excerpt, see full legal text):</p>
    <blockquote>...kept in a form which permits identification of data subjects for no longer than is necessary...</blockquote>
    <p>Finally, <a href="https://www.privacy-regulation.eu/en/article-89-safeguards-and-derogations-relating-to-processing-for-archiving-purposes-the-public-interest-scientific-or-hi-GDPR.htm" target="_blank" rel="noopener">Article 89(1)</a> states (trimmed excerpt, see full legal text):</p>
    <blockquote>Processing for (...) statistical purposes, shall be subject to appropriate safeguards (...) Those measures may include pseudonymisation...</blockquote>

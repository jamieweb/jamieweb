...
<?php include_once "bloglist.php"; bloglist("navbar"); ?>
            ...
            <li class="dropdown">
                <h5><a href="/tools/"><span>&#x1f6e0;&#xfe0e;</span> <span>Tools & Apps</span></a></h5>
                <div class="dropdown-content">
                    <h4>
                        <a href="/apps/lookalike-domains-test/">Lookalike Domain Names Test</a>
            ...
            <li class="float-right">
                <h5><a href="/rss/" target="_blank"><img class="invert exempt" height="14px" width="14px" src="/images/fontawesome/rss.svg"> <span>RSS Feed</span></a></h5>
            </li>
        </ul>
    </div>
</nav>

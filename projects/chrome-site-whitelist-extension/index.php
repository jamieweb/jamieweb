...
<div class="body">
    ...
    <p>All code and further details are available on the GitHub respository: <a href="https://github.com/JamieOnUbuntu/results-whitelist/" target="_blank">https://github.com/JamieOnUbuntu/results-whitelist/</a></p>
    ...
    <ul>
        <div class="ext-l-1">
            <li><p><b>Download the ZIP from GitHub and extract the contained folder.</b></p>
                <ul>
                    <li><p>GitHub Repo:<br/><a href="https://github.com/JamieOnUbuntu/results-whitelist/" target="_blank" >https://github.com/JamieOnUbuntu/results-whitelist/</a></p></li>
                    <li><p>Direct Link:<br/><a href="https://github.com/JamieOnUbuntu/results-whitelist/archive/master.zip" target="_blank">https://github.com/JamieOnUbuntu/results-whitelist/archive/master.zip</a></p></li>
                </ul>
            </li>
        </div>
        <div class="ext-r-1">

...
<div class="body">
    ...
    <h2 id="jamieweb" class="two-mar-bottom redlink"><a href="/" target="_blank" rel="noopener">JamieWeb.net (This Website)</a></h2>
    <p class="two-mar-top">My personal security blog and website - the one you're reading right now. I started the site in 2011, but shifted its focus to IT security and infrastructure in 2016. It's hosted on a pair of geo-diverse Ubuntu 18.04 cloud servers (London and New York City) using Apache, and a Cloudflare DNS load balancer is used in active failover mode to ensure that the site remains at 100% uptime, even when one of the servers is rebooted. The entire server configuration and build process is automated and version controlled using Ansible and Git, meaning that I can easily design and test changes in a safe environment before deploying them to production.</p>
    <p>&#x1f310; <a href="/" target="_blank" rel="noopener">Homepage</a> | <img class="gl-logo-svg" src="/images/svg-logos/gitlab.svg" width="55px" title="GitLab"><a href="https://gitlab.com/jamieweb/jamieweb/" target="_blank" rel="noopener">Source Code</a> | <img class="vertical-align-middle" src="/images/svg-logos/php.svg" width="50px" title="PHP"> Written in <a href="https://php.net/" target="_blank" rel="noopener">PHP</a></p>
    <hr>
    ...
    <h2 id="domain-name-expiry-monitor" class="two-mar-bottom redlink"><a href="https://gitlab.com/jamie-cyc/domain-monitor/" target="_blank" rel="noopener">Domain Name Expiry Monitor</a></h2>
    <p class="two-mar-top">A domain name expiry monitoring and reporting tool designed to produce weekly email reports on your domain names that have upcoming renewals, including renewals due in the next 7, 28 and 90 days. A list of domain names to monitor is specified in a configuration file, which is then used by the tool to make WHOIS lookups to the relevant WHOIS servers in order to check the expiry date. This data is stored, and can then be used to produce a weekly report to be sent via email.</p>
    <p><img class="gl-logo-svg" src="/images/svg-logos/gitlab.svg" width="55px" title="GitLab"><a href="https://gitlab.com/jamie-cyc/domain-monitor/" target="_blank" rel="noopener">Source Code</a> | <img class="vertical-align-middle" src="/images/svg-logos/php.svg" width="50px" title="PHP"> Written in <a href="https://www.php.net/" target="_blank" rel="noopener">PHP</a></p>
    <hr>

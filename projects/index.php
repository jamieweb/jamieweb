...
<div class="body">
    ...
    <h2 class="no-mar-bottom redlink"><a href="/projects/computing-stats/">Raspberry Pi Cluster</a></h2>
    ...
    <h2 class="no-mar-bottom redlink"><a href="/" target="_blank" rel="noopener">DigitalOcean Tutorials</a></h2>
    <p class="two-mar-top">I am a freelance technical writer for the cloud computing company DigitalOcean, where I write guides and tutorials about Linux, DNS, web technologies and more. I have covered topics including DNS infrastructure-as-code tools and email security. The payments for my work are kindly matched by DigitalOcean as a charitable donation to the Electronic Frontier Foundation.</p>
    <p>&#x1f4dd; <a href="" target="_blank" rel="noopener">My DigitalOcean Tutorials</a></p>
    <hr>

    <h2 class="two-mar-bottom redlink"><a href="https://gitlab.com/jamieweb/web-server-log-anonymizer-bloom-filter/" target="_blank" rel="noopener">Web Server Log File Anonymizer</a></h2>
    ...
    <p>&lt;/&gt; <a href="https://gitlab.com/jamieweb/web-server-log-anonymizer-bloom-filter/" target="_blank" rel="noopener">Source Code</a> | &#x1f4c3; <a href="/blog/using-a-bloom-filter-to-anonymize-web-server-logs/">Blog Post</a> | <> <a href="https://www.python.org/" target="_blank" rel="noopener">Python 3</a></p>
    <hr>

    <h2 class="two-mar-bottom redlink"><a href="https://gitlab.com/jamieweb/travis-ci_csp-tester/" target="_blank" rel="noopener">Content Security Policy Tester CI Pipeline Job</a></h2>
    ...
    <p>&lt;/&gt; <a href="https://gitlab.com/jamieweb/travis-ci_csp-tester/" target="_blank" rel="noopener">Source Code</a> | &#x1f4c3; <a href="/blog/testing-your-csp-using-travis-ci-and-headless-chrome-crawler/">Blog Post</a> | <> <a href="https://yaml.org/" target="_blank" rel="noopener">YAML</a></p>
    <hr>

    <h2 class="two-mar-bottom redlink"><a href="https://gitlab.com/jamieweb/dl-integrity-verify/" target="_blank" rel="noopener">Automatic Software Package Integrity Verifier</a></h2>
    ...
    <p>&lt;/&gt; <a href="https://gitlab.com/jamieweb/dl-integrity-verify/" target="_blank" rel="noopener">Source Code</a> | &#x1f4c3; <a href="/blog/automating-the-integrity-verification-process-for-downloaded-software/">Blog Post</a> | <> <a href="https://www.gnu.org/software/bash/" target="_blank" rel="noopener">Bash</a></p>
    <hr>

    <h2 class="two-mar-bottom redlink"><a href="https://gitlab.com/jamieweb/results-whitelist/" target="_blank" rel="noopener">Link Whitelist Chrome Extension</a></h2>
    <p class="two-mar-top">A Google Chrome extension which allows you to set a whitelist of trusted websites. Hyperlinks to these websites in Google search results, Reddit and Hacker News will then be highlighted in green. This is anti-typosquatting and anti-phishing tool designed to remove the requirement to carefully check links before clicking on them, and to provide assurance that the link you're clicking isn't a lookalike or phishing website.</p>
    <p>&lt;/&gt; <a href="https://gitlab.com/jamieweb/results-whitelist/" target="_blank" rel="noopener">Source Code</a> | &#x1f4c3; <a href="/blog/chrome-site-whitelist-extension/">Blog Post</a> | <> <a href="https://en.wikipedia.org/wiki/JavaScript" target="_blank" rel="noopener">JavaScript</a></p>
    <hr>

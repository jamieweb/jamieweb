...
<head>
    <title>Sponsoring jamieweb.net</title>
    <meta name="description" content="If you are interested in sponsoring jamieweb.net, this page contains everything you need to know.">
    <?php include "head.php" ?>
    <link href="https://www.jamieweb.net/sponsor/" rel="canonical">
</head>
...
<div class="body">
    ...
    <p>One month of sponsorship currently costs <b>$60 US</b>.</p>
    <p>If you wish to sponsor me for multiple months, I may offer reduced rates. I can accept the following payment methods:</p>
    <ul>
        <li>UK bank transfer</li>
        <li>PayPal</li>
        <li>Other of your choice (upon agreement)</li>
    </ul>
    <p>If you're interested, please <a href="#contact">contact me</a>.</p>
    ...
    <p>If you'd like to enquire regarding a sponsorship, please send an email to:</p>
